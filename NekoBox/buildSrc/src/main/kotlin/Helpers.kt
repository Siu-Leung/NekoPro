...
fun Project.setupAppCommon() {
    ...
    val keystorePath = lp.getProperty("KEYSTORE_PATH") ?: System.getenv("KEYSTORE_PATH") ?: System.getenv("RELEASE_KEYSTORE_PATH")
    val keystorePwd = lp.getProperty("KEYSTORE_PASS") ?: System.getenv("KEYSTORE_PASS")
    val alias = lp.getProperty("ALIAS_NAME") ?: System.getenv("ALIAS_NAME")
    val pwd = lp.getProperty("ALIAS_PASS") ?: System.getenv("ALIAS_PASS")

    android.apply {
        if (releaseRequested && !keystorePwd.isNullOrBlank()) {
            val keystore = if (!keystorePath.isNullOrBlank()) {
                java.io.File(keystorePath).canonicalFile
            } else {
            ...
            if (keystore.exists()) {
                signingConfigs {
                    create("release") {
                        ...
                        keyAlias = alias ?: "neko_test1"
                        keyPassword = pwd ?: keystorePwd
                    }
                }
            }
        }
